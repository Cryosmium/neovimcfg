...
-- NOTE: Change if there are no nerd fonts installed
...
-- Preview substitutions live, as they are typed!
...
-- Sane keybind for exiting terminal mode
...
vim.keymap.set('n', 'H', '<cmd>bnext<CR>', { desc = 'Move focus to the next buffer' })
vim.keymap.set('n', 'L', '<cmd>bprev<CR>', { desc = 'Move focus to the previous buffer' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    event = 'VimEnter',
    opts = {
      -- NOTE: this setting is independent of vim.o.timeoutlen
      delay = 0,
      icons = {
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Jump to the *def*inition of the word under cursor.
          map('grd', require('telescope.builtin').lsp_definitions, '[G]oto [D]efinition')

          -- Jump to the *decl*aration of the word under cursor.
